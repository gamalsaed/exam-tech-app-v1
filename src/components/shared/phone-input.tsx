    ...
    ({ className, onChange, value, errorMessage, ...props }, ref) => {
      return (
        <div className=" flex flex-col gap-2.5">
          <label className="text-base mb-1 font-medium text-gray-800 font-mono">
            Phone
          </label>
          <label className=" w-full group">
            <div
              className={`w-full outline outline-2 block ${
                errorMessage ? "outline-red-500 " : "  outline-gray-200"
              }  transition-colors group-focus-within:outline-blue-600`}
            >
              <RPNInput.default
                ref={ref}
  ...
  return (
    ...
    >
      <PopoverTrigger asChild>
        <Button
          type="button"
          className="flex gap-2 px-3 focus:z-10 bg-white hover:bg-white font-mono "
          disabled={disabled}
        >
          <FlagComponent
